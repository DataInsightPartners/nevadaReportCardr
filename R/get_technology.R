...
get_technology <- function(org_ids, spring_years = 2012:2018) {
  ...
  valid_years <- 2012:2018

  if (is.null(spring_years)) return(stop("Invalid spring_years provided. Must be 2012 through 2018."))

  for (year in spring_years) {
    if (!year %in% valid_years) {
      return(stop("Invalid spring_years provided. Must be 2012 through 2018."))
    }
  }
